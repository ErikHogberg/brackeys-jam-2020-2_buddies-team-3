...
namespace brackeys2020_buddiesteam3
{
	public static class Globals
	{
		public static class Colors
		{
			...
			public static Color BreakingPlatform = new Color(127, 0, 0);            //darkish red, hex: 7f0000
			public static Color MovingPlatform = new Color(127, 0, 0);          //darkish red, hex: 7f0000
			public static Color Spikes = new Color(191, 0, 191);            //pink, hex: bf00bf 
			public static Color Button = new Color(255, 0, 0);
